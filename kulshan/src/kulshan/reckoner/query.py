...
def _resolved_period(query: QuerySpec) -> ResolvedRange:
    if query.period.period_id != "custom":
        raise QueryExecutionError("named period resolution is deferred until period discovery")
